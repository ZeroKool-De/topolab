...
<head>
    ...
    <!-- Quick Add JavaScript - INIZIO BLOCCO AGGIUNTO -->
    <script>
        // Passa le informazioni PHP al JavaScript per il Quick Add
        window.PHP_IS_CONTRIBUTOR = <?php echo json_encode($is_contributor_only); ?>;
        window.BASE_URL = <?php echo json_encode(BASE_URL); ?>;
    </script>
    
    <!-- Quick Add Script -->
    <script src="<?php echo BASE_URL; ?>admin/js/quick-add.js?v=<?php echo time(); ?>"></script>
    <!-- Quick Add JavaScript - FINE BLOCCO AGGIUNTO -->
